...
class TailorChatDetailScreen extends StatefulWidget {
  final String otherUserId;
  final String otherUserName;
  final String? otherUserImageUrl;

  const TailorChatDetailScreen({
    super.key,
  ...
  @override
  State<TailorChatDetailScreen> createState() => _TailorChatDetailScreenState();
}

class _TailorChatDetailScreenState extends State<TailorChatDetailScreen> {
  ...
  Future<void> _sendVoiceNote(String path) async {
    ...
    if (authProvider.user != null) {
      try {
        final audioUrl = await chatProvider.uploadAudio(path); if (audioUrl == null) throw Exception('Upload failed'); await chatProvider.sendMessage(
                  ...
                  children: [
                    Container(
                      ...
                      child: FractionallySizedBox(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            color: widget.isSent ? Colors.white : const Color(0xFF2E7D32),
                            borderRadius: BorderRadius.circular(2),
                          ),
                        ),
                      ),
